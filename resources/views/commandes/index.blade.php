                    ...
                    <table class="table-auto border">
                        ...
                        <thead>
                            ...
                            <tr class="border">
                                ...
                                <th class="p-5">ID</th>
                                <th class="p-5">NOM</th>
                                <th class="p-5 mx-3 flex justify-between items-center">ACTIONS<x-btn-creer><a href="{{route('commandes.create')}}">CREER</a></x-btn-creer></th>
                        ...
                        <tbody>
                            ...
                            <tr class="border text-center">
                                ...
                                <td class="p-5">
                                    ...
                                    @slot('route')
                                    {{route('commandes.edit', $commande->id)}}
                                    @endslot
                                    @slot('class')
